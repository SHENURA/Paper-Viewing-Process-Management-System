...
<meta charset="UTF-8">
    ...
    /* Main Footer */
    footer .main-footer{font-family: 'Acme';box-shadow: -3px -3px 5px black;	padding: 20px 0;	background: #07698c;    border-top: 2px solid black;}
    ...
    /* Copy Right Footer */
    .footer-copyright {	background-color:  #033159;	padding: 5px 0;box-shadow: -1px -1px 3px black;border-top:1px solid black;}
...
<footer style = "font-size : 18px;" id="footer" class="footer-1">
    ...
    <h2 class="widget-title mylink" style = "font-family:Acme;"><b><a href = "http://www.rvce.edu.in">RVCE</a></b></h2>
    <p style="color:#fff;"><i class="fa fa-map-marker-alt" aria-hidden="true" style = "font-size:15px;color:#fff;"></i>  Address:
    Mysore Rd, RV Vidyaniketan, Post, Bengaluru, Karnataka 560059, India.</p>
    </div>
    </div>
    ...
    <li>
    <div class="thumb-content"><a href="https://rvce.edu.in/rvce-center-excellence">COE Notifications</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a href="https://rvce.edu.in/ug-pg-programs">UG and PG Programs</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a href="https://rvce.edu.in/rvce-students-clubs-technical-innovative">Student Clubs</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a href="https://scet.in/wp-content/uploads/2021/07/Examination_Malpractice_Rules.pdf">Malpractice Rules & Regulations</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a href="about.php">About</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a  href="	https://www.rvce.edu.in/contact-us" target="_blank">Contact Us</a></div>	
    </li>
    </ul>
    </div>
    </div>
    ...
    <li><a  href="https://www.rvce.edu.in/rvce-media" target="_blank">Rvce Media</a></li>
    <li><a  href="https://rvce.edu.in/ise-newsletter" target="_blank">Newsletters</a></li>
    <li><a  href="https://rvce.edu.in/rvce-ise-main-page" target="_blank">ISE Dept</a></li>
    <li><a  href="https://rvce.edu.in/calendar-of-events" target="_blank">Calendar Of Events</a></li>
    <li><a  href="https://rvce.edu.in/rvce-scheme-syllabus" target="_blank">Syllabus</a></li>
    </ul>
    </div>
    </div>
    ...
    <p style= "color : #D0D3D4;"><a href="mailto:" title="glorythemes" style="color:orange;"><i class='far fa-envelope' style='font-size:14px'></i> principal
rvce.edu.in</a></p>
    <p><i class='fas fa-phone-square'></i> +91-080-68188100/8111</p>
    ...
    <p style = "font-family:'PT serif';color:white;">© Copyright 2023, All Rights Reserved.</p>
    </div>
    </div>
    </div>
    </div>
